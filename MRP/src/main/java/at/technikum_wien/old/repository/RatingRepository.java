...
import at.technikum_wien.old.repository.interfaces.IRepoDelete;
import at.technikum_wien.old.repository.interfaces.IRepoGetByID;
import at.technikum_wien.old.repository.interfaces.IRepoSave;
import at.technikum_wien.old.util.DatabaseConnection;

import java.sql.*;

public class RatingRepository implements IRepoSave<Rating>, IRepoGetByID<Rating>, IRepoDelete<Rating> {
